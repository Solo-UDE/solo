...
/**
 * Subtle banner shown above the chat input when a chat-only model is selected.
 *
  ...
  return (
    <div className="mx-2 mb-1 flex items-center gap-2 px-2 py-1.5 rounded-none bg-muted/40 border border-border/60 text-xs text-muted-foreground">
      ...
      <span className="flex-1">
        This model is chat-only in this build. Switch to Claude if you need file edits or tool use.
      </span>
      <button
        type="button"
