...
(your agent can copy this) | Input Format | Output Format | Requirement | Use Case |
|--------------|---------------|-------------|----------|
...
(makrdown for your agents to copy) | Input Method | Output Format | Use Case |
|--------------|---------------|----------|
| Argument | text | Quick questions |
| Argument | json | Programmatic single response |
| Stdin pipe | text | Processing files/diffs |
| Stdin pipe | json | CI/CD pipelines |
| Here-doc | text | Complex multi-line prompts |
| Here-doc | json | Scripted automation |
| Stream-json | stream-json | Real-time bidirectional chat |
...
Quick Reference
(for your agents to copy)  | Goal | Command |
|------|---------|
